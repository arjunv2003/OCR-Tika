...
def clean_text(text):
    """Remove extra spaces and blank lines from extracted text."""
    return "\n".join(line.strip() for line in text.splitlines() if line.strip())

def extract_text_from_pdf(file_path):
    """Extract text from a text-based PDF using Tika."""
    parsed = parser.from_file(file_path)
    return clean_text(parsed["content"] or "")
...
# Folder containing the CVs
cv_folder = r"C:\Users\USER\Desktop\OCRs\OCR\pdf_image"  # Replace with the actual folder path
output_folder = r"C:\Users\USER\Desktop\OCRs\OCR\output"   # Replace with the desired output folder path
